...
export const WETH9: TokenMap = {
  ...
  [ChainId.BITKUB_CHAIN_TESTNET]: new Token(
    ChainId.BITKUB_CHAIN_TESTNET,
    WETH9_ADDRESS[ChainId.BITKUB_CHAIN_TESTNET],
    18,
    "WKUB",
    "Wrapped Kub"
  ),
...
export const WNATIVE: TokenMap = {
  ...
  [ChainId.BITKUB_CHAIN_TESTNET]: WETH9[ChainId.BITKUB_CHAIN_TESTNET],
};
